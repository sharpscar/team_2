...
struct inven setting_shop(struct inven shop_inven)
{
    ...
    shop_inven.sw[0] =set_sword(sword1_basic,"기본검", 1,0,2,0,0,50,0,0);
    shop_inven.sw[1] =set_sword(sword2_longsword,"장검",2,0, 10,0,0,500,0,0);
    shop_inven.sw[2] =set_sword(sword3_japanese,"일본도",3,0, 20,0,0,1000,0,0);

    struct amor amor1_leather;
    struct amor amor2_iron;
    

    amor1_leather=set_amor(amor1_leather,"가죽갑옷",0,-2,0,0,0,50,0,0,0,0);
    amor2_iron=set_amor(amor2_iron,"철갑옷",0,-6,0,0,0,50,0,0,0,0);
    shop_inven.am[0]=amor1_leather;
    shop_inven.am[1]=amor2_iron;
// "천망토","면망토","가죽투구","철투구",
// "빨간물약","주황물약","맑은물약","파란물약","하얀물약","무지개물약","해독제","축복주문서","마을이동주문서","순간이동주문서"};
//명칭 뒤에는 내가 새로 추가한 index라는 값이 있는데 이게 -1이 아니면 어디서든 줏거나 얻은거야!
// "가죽갑옷","철갑옷","가죽신발","철신발","가죽장갑","철장갑","천망토","면망토","가죽투구","철투구","빨간물약","주황물약","맑은물약","파란물약","하얀물약","무지개물약","해독제","축복주문서","마을이동주문서","순간이동주문서"};

    struct amor amor1_leather_shoes;
    struct amor amor2_iron_shoes;
    amor1_leather_shoes= set_amor(amor1_leather_shoes,"가죽신발",0,-1,0,0,0,50,0,0,0,0);
    amor2_iron_shoes= set_amor(amor2_iron_shoes,"철신발",0,-3,0,0,0,600,0,0,0,0);
    ...
    amor1_leather_gloves= set_amor(amor1_leather_gloves,"가죽장갑",0,-1,0,0,0,50,0,0,0,0);
    amor2_iron_gloves   = set_amor(amor2_iron_gloves,"철장갑",0,-3,0,0,0,600,0,0,0,0);
    ...
    amor1_leather_cloak= set_amor(
        amor1_leather_cloak,"천망토",0,-1,0,0,0,50,0,0,0,0);
    amor2_cotton_cloack= set_amor(
        amor2_cotton_cloack,"면망토",0,-3,0,0,0,600,0,0,0,0);
    ...
    amor1_leather_helmet= set_amor(
        amor1_leather_helmet,"가죽투구",0,-1,0,0,0,50,0,0,0,0);
    amor2_iron_helmet= set_amor(
        amor2_iron_helmet,"철투구",0,-3,0,0,0,600,0,0,0,0);
    ...
    printf("%d",  sizeof(shop_inven.sw)/sizeof(struct sword));
    // while(1)
    // {
